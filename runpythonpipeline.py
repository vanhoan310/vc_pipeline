...
vcf_list = glob.glob("/data/hoan/gwas/brca_analysis/GRCh38_out/out/filtered_snps/*2.vcf")
...
for input_file in vcf_list:
    ...
    output_file = '/data/hoan/gwas/brca_analysis/GRCh38_out/'+file_name+'snps_dbSnp_ann.vcf'
    cmd_SNPSift = snpsift_bin + database + ' ' + input_file + ' > ' + output_file
    os.system(cmd_SNPSift)
    print('------------------------------------------------------------------------------------\n')
