...
process markDuplicatesSpark {
    ...
    /data/hoan/gwas/brca_analysis/gatk-4.3.0.0/./gatk --java-options "-Djava.io.tmpdir=${params.tmpdir}/${workflow.runName}/${pair_id}" \
	 MarkDuplicatesSpark \
	-I $aligned_reads \
	-M ${pair_id}_dedup_metrics.txt -O ${pair_id}_sorted_dedup.bam 
...
/*     script: */
/*     """ */
/*     ~/miniconda3/envs/py27/bin/java -jar SnpSift.jar annotate -clinvar $filtered_snps \ */
/*     | java -Xmx8g -jar snpEff.jar eff -v GRCh37.p13 - \ */
/*     | java -jar SnpSift.jar filter "! exists ID" \ */
/*     > ${pair_id}_filtered_snps.ann.vcff */
/*     """ */
/* } */
